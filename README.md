...
pixi global install fontconfig
```
...
It is possible to list all of the versions of `fontconfig` available on your platform:
...
```
pixi search fontconfig --channel conda-forge
```
